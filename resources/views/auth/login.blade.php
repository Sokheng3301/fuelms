            ...
            <div class="col-md-5 bg-img-login">
                <div class="col-10 col-md-9 col-lg-8 col-xl-8">
                    <form action="{{ route('login.save') }}" method="POST" class="ui form">
                        @csrf
                        <img class="ui image small d-block mx-auto mb-4" src="{{ asset('dist/assets/img/logo.png') }}" alt="">
                        ...
                        <div class="field">
                            ...
                            <div class="ui icon large input">
                                ...
                                <input type="text" name="username" id="username" autofocus placeholder="{{ __('Username') }}" value="{{ old('username') }}">
                        ...
                        <div class="field">
                            ...
                            <div class="ui icon large input">
                                ...
                                <input type="password" name="password" id="password" autofocus placeholder="{{ __('Password') }}">
                                {{-- <i class="bi bi-user icon"></i> --}}
                            </div>
                        </div>
                        <div class="field">
                        ...
                        <button type="submit" class="ui button login_button w-100 mt-3 large">{{__("Login")}}</button>
                        <p class="m-0 mt-4 text-center">{{__("Forgot password?")}} <a type="button" data-bs-toggle="modal" data-bs-target="#readInfo"class="link text-success">{{__('More info')}}</a></p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title ui medium header" id="readInfoLabel"> <i class="bi bi-chat-right-text-fill pe-1"></i> {{ __('Message from Fuel System') }} </h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="ui tiny button " data-bs-dismiss="modal"> {{ __('Close') }} </button>
